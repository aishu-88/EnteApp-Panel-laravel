{{-- resources/views/admin/auth/logout.blade.php --}}
<!doctype html>
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable" data-theme="default" data-theme-colors="default">
<head>
    <meta charset="utf-8" />
    <title>Log Out | Panchayath Admin Panel</title>
                        ...
                        <div class="card mt-4 card-bg-fill">
                            <div class="card-body p-4 text-center">
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <p class="text-muted">Thank you for using <span class="fw-semibold">Panchayath Connect</span> admin panel</p>
                                    <div class="mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Panchayath Admin Panel. Crafted with <i class="mdi mdi-heart text-danger"></i> by xAI
                            </p>
                        </div>
                    </div>
                </div>
