            ...
            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select name="offerStatus"
                            class="form-select @error('offerStatus') is-invalid @enderror"
                            required>
                            <option value="active" {{ old('offerStatus') == 'active' ? 'selected' : '' }}>
                                Active
                            </option>
                            <option value="inactive" {{ old('offerStatus') == 'inactive' ? 'selected' : '' }}>
                                Inactive
                            </option>
                        </select>
